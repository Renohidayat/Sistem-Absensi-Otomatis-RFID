...
for i, line in enumerate(lines):
    if 'renderStatistikMuridDanKelas()' in line:
        start_idx = i
    if start_idx != -1 and 'renderJumlahMurid()' in line:
        end_idx = i
        break
...
if start_idx != -1 and end_idx != -1:
    ...
    # Also update admin.html version
    with codecs.open('admin.html', 'r', encoding='utf-8') as f:
        html = f.read()
    with codecs.open('admin.html', 'w', encoding='utf-8') as f:
        f.write(html.replace('js/app.js?v=10', 'js/app.js?v=11'))
        
    print("SUCCESS JS SPLIT")
else:
